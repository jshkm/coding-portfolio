        ...
        <div className='flex flex-col justify-between items-center h-full w-full py-6'>
            ...
            >
                ...
                >
                    ...
                    <motion.div
                        className='w-full xl:h-1/2 flex flex-col xl:flex-row xl:space-x-2 space-y-4 justify-around items-center'
                        variants={item}
                    >
                        <img className='w-1/2 xl:w-fit xl:h-full aspect-square object-cover rounded-xl' src={'/images/headshot.jpg'} alt={'headshot'}></img>
                        <div className='w-full xl:w-1/3 xl:h-full flex flex-col text-left justify-start'>
